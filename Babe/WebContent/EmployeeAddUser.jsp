...
<body>
	...
	<form role="form" data-toggle="validator" name="signupForm"
		action="${pageContext.request.contextPath}/EaddU" method="POST">
		<div Class="Reg">
		...
		<form class = "addUser" action = "${pageContext.request.contextPath}/EaddU" method="get">
			<input type="submit" name="Add" value="Add">
		</form>	
	</form>

	<input type="submit" class="btn btn-default pull-left"
		data-dismiss="modal" value="Cancel" onclick="window.location.href='showUsers.jsp'">
