...
<body>
	...
	<form class = "EeditE"  method = "post" action="${pageContext.request.contextPath}/MupdateM">
	...
	<form class = "ECancel" method = "post" action = "${pageContext.request.contextPath}/ManagerProfile.jsp">
