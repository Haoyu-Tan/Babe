			...
			if (per != null){
				...
				if (per.getpassword().equals(password)) {
					...
					if(emp.getRole().equals("CustRep")) {
						...
						System.out.println(contextPath + "/ManagerProfile.jsp");
