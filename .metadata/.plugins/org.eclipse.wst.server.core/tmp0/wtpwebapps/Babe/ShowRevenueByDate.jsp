...
<title>Show Revenue By Date</title>
</head>
<body>
<h2>
Below is a list of revenue that generate by a specific of time
</h2>
<body>
<%
	System.out.println("before get session");
	ArrayList<Dates> dateList = WebpgUtil.getRevenueByDate(WebpgUtil.getSearchRevenueByTimeSession());
	System.out.println("size is " + dateList.size());
