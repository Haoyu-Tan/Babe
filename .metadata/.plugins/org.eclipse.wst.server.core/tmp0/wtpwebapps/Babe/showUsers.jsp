...
<table style="width:100%" border = "1">
	...
	<% 	
		...
		<tr>
			<form class = "userInfo" action = "${pageContext.request.contextPath}/UUS">
			<td>
	...
	<form class = "addUser" action = "${pageContext.request.contextPath}/EmployeeAddUser.jsp" method="get">
			<input type="submit" name="Add" value="Add" maxlength="35">
	</form>
	<form class = "Back" action = "${pageContext.request.contextPath}/EmployeeProfile.jsp" method="get">
