...
<body>
	...
	<form role="form" data-toggle="validator" name="signupForm"
		action="${pageContext.request.contextPath}/MaddU" method="POST">
		<div Class="Reg">
		...
		<div Class="Reg">
			<input type="text" class="form-control" name="CreditCardNo"
		...
		<form class = "addUser" action = "${pageContext.request.contextPath}/MaddU" method="get">
			<input type="submit" name="Add" value="Add">
		</form>	
	</form>

	<input type="submit" class="btn btn-default pull-left"
		data-dismiss="modal" value="Cancel" onclick="window.location.href='ManagerShowUsers.jsp'">
