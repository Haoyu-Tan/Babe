...
<form class = "EeditU"  method = "post" action = "${pageContext.request.contextPath}/MupdateU">
...
<form class = "EeditU"  method = "post" action = "${pageContext.request.contextPath}/ManagerShowUsers.jsp">
