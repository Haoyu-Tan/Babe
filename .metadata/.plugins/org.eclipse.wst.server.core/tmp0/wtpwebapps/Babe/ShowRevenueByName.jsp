...
<title>Show Revenue By Name</title>
</head>
<body>
<h2>
Below is a list of revenue that generated by name
</h2>
<body>
<%
	System.out.println("before get session");
	ArrayList<Dates> dateList = WebpgUtil.getRevenueByName(WebpgUtil.getSearchRevenueByNameSession());
